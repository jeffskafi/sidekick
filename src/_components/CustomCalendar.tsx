...
const CustomCalendar: React.FC<CustomCalendarProps> = ({
  ...
  return (
    <div
      className={`${styles.calendar} ${theme === "dark" ? styles.calendarDark : styles.calendarLight}`}
    >
      <div className={styles.header}>
        <button
          onClick={prevMonth}
          className={`${styles.navButton} ${theme === "dark" ? styles.navButtonDark : styles.navButtonLight}`}
        >
          <ChevronLeft size={20} />
        </button>
